<div class="row">
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              <h6 class="mb-2 f-w-400 text-muted">Total Games</h6>
              <h4 class="mb-3"><?php echo $data['total_games'] ?? 0; ?> <span class="badge bg-light-primary border border-primary"><i
                    class="ti ti-trending-up"></i> 100%</span></h4>
              <p class="mb-0 text-muted text-sm">Games in catalog</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              <h6 class="mb-2 f-w-400 text-muted">Games This Month</h6>
              <h4 class="mb-3"><?php echo $data['games_this_month'] ?? 0; ?> <span class="badge bg-light-success border border-success"><i
                    class="ti ti-trending-up"></i> New</span></h4>
              <p class="mb-0 text-muted text-sm">Added this month</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-3">78,250 <span class="badge bg-light-warning border border-warning"><i
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-3">1,234 <span class="badge bg-light-info border border-info"><i
                    class="ti ti-activity"></i> Live</span></h4>
              <p class="mb-0 text-muted text-sm">Current active users</p>
            </div>
          </div>
        </div>
